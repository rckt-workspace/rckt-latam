    ...
    <div className="min-h-screen bg-background text-foreground antialiased">
      ...
      <main>
        <SystemPageHero
          ...
          context="Campañas, conversaciones de WhatsApp, CRM e IA supervisada, medidos hasta el ingreso. Trabajamos con empresas que ya venden e invierten en mercadeo, y pierden plata entre la pauta y el cierre. Operamos en Latinoamérica desde Colombia: Bogotá, Medellín y Barranquilla."
        ...
        <section className="page-section"><div className="page-shell"><SectionHeader num="05." label="A quién servimos" title="A quién servimos." /><p className="mt-8 max-w-[900px] text-[18px] leading-[1.7] text-muted-foreground">Nuestro cliente ya vende, ya invierte en mercadeo o ventas y recibe leads, pero pierde plata entre la pauta y el cierre. El tamaño no es un filtro absoluto: una empresa de 12 personas con ticket alto y margen es mejor cliente que una de 80 con márgenes bajos.</p></div></section>

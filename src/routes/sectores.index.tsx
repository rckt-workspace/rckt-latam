...
function SectoresPage() {
  ...
  return (
    <div className="rckt-site tcn-page">
      <main id="top">
        <SystemPageHero label="Sectores" descriptor="Cada sector vende distinto. Aquí ves cómo vende hoy el tuyo, dónde se le escapa el dinero, y qué sistema recomendamos según tu forma real de vender." title={<>Vendemos distinto según cómo vende cada <em>sector</em>.</>} promise="Revenue Systems adaptados a la forma real de vender de cada sector." ctaLabel="Revisar mi proceso comercial →" />

...
const SECTORES = ["Salud", "Educación", "Construcción", "Servicios B2B", "Ecommerce", "Industria"];
...
export const Route = createFileRoute("/casos/")({
  ...
  head: () => ({
    meta: [
      { title: "Casos con ficha completa | RCKT" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Casos con ficha completa | RCKT" },
      {

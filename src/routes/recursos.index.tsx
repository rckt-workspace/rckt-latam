  ...
  return <div className="min-h-screen bg-background text-foreground"><SiteNav /><main>
    ...
    <section className="recursos-catalog">
      <div className="mx-auto max-w-6xl px-5 pt-10 pb-16 md:px-6 md:pt-16 md:pb-24">
        <div className="relative max-w-md"><Search className="pointer-events-none absolute top-1/2 left-4 z-10 h-4 w-4 -translate-y-1/2 text-muted-foreground" aria-hidden="true" /><input type="search" value={query} onChange={(event) => setQuery(event.target.value)} placeholder="Buscar recursos" aria-label="Buscar recursos" className="res-input w-full rounded-full py-3 pr-4 !pl-12 text-[14px] text-foreground outline-none" /></div>

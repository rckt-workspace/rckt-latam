...
function Privacidad() {
  return (
    <LegalPage title="Política de Privacidad">
      ...
      <p>RCKT S.A.S. cuenta con una Política de Tratamiento de Datos Personales propia, disponible a solicitud en privacy@rckt.lat.</p>
      <p><a href="/RCKT-SAS-Politica-de-Tratamiento-de-Datos.pdf" target="_blank" rel="noopener noreferrer">Política de Tratamiento de Datos Personales</a></p>
      <h3>b. México</h3>

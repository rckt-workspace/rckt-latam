...
export const SISTEMAS_CARDS: SystemCardData[] = [
  {
    ...
    title: "Demand System",
    shortName: "Demand",
    desc: "Cuando optimizas por costo por lead, las plataformas aprenden a traerte a quien llena formularios, no a quien compra. Manejamos tu pauta por las oportunidades que tu equipo acepta y por las que terminan en venta.",
  ...
  },
  {
    ...
    desc: "El prospecto te escribe por WhatsApp y la respuesta depende de quién esté libre. Sales Flow conecta tu pauta, WhatsApp y CRM: cada conversación con respuesta, seguimiento y dueño, y cada venta de vuelta a Meta y Google.",
  ...
  },
  {
    ...
    desc: "6 de cada 10 pymes no ven retorno de la IA. Por eso empezamos por un proceso, no por una herramienta: medimos cuánto cuesta hoy y lo dejamos funcionando con una persona aprobando lo que importa.",
